...
(function ($) {
    ...
    * @constructor
    */
    $.Autocompleter = function ($elem, options, afterTapCallBack) {
        /*
        after CB
        */
        this.afterTapCallBack = afterTapCallBack || function () { };
    ...
    */
    $.Autocompleter.prototype.createItemFromResult = function (result) {
        ...
        .bind("tap", function () { self.selectItem($li); self.afterTapCallBack(result.value); })
